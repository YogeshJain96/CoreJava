...
Naming conventions 
class , interfaces , enum names-  1st word must start with upper case & then follow camel case notation.
...
Solve : Write java application to accept int , double , user's first name , boolean from Scanner & display the same using printf.
...
Revise "this" keyword
Usages of this
1. To unhide , instance variables from method local variables.(to resove the conflict)
eg : this.name=name
