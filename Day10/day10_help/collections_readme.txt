...
---List imple class backed up by an array.
...
API 
ArrayList(int capacity) -- -- creates EMPTY array list object , with init capacity=capacity,size=0;
...
NOTE : 
For searching or removing in List Implementation classes --- All search methods (contains,indexOf,lastIndexOf,remove(Object o)) -- based upon equals method(of type of List eg --Account/Customer/Emp/Student etc.)
For correct working of List API --contains,indexOf,lastIndexOf,remove(Object o)) 
