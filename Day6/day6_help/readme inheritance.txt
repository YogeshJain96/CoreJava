...
eg : class A { void show(){sop("in A's show");}}
class B extends A {
...
eg : Organize following in suitable classes.
...
2. Add Orange
3. Add Cherry
4. Exit : Display taste of all fruits in the basket & terminate the application.
...
Add static method(generateShape)  to return randomly generated shape.
...
same method name
method paramters -- different (no/type/both)
...
RULE -- when javac doesn't find exact match --tries to resolve it by the most specific type.
...
To replace reference  equality by content  equality , based upon identity (i.e analogous to primary key criteria.)
...
Can you declare a method which is private & abstract ? NO
Can you declare a method which is  abstract & final ? NO
Can you declare a method which is  abstract & static ? NO

eg : public abstract void taste();
...
Yes 
eg --- Event adapter classes, Servlet class

Use "abstract" keyword in Fruits/Shapes  hierarchy & test it
--------------------
